...
const StudyGuides: React.FC = () => {
                                ...
                                <div className="space-y-3">
                                    {selectedGuide.common_mistakes.map((m, i) => (
                                        <div key={i} className="p-4 bg-red-50 border border-red-100 rounded-lg flex gap-4">
                                            ...
                                            <div>
                                                <p className="font-medium text-red-800 mb-1">Mistake: {m.mistake}</p>
                                                <p className="text-red-600 text-sm">Correction: {m.correction}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
    ...
    return (
        <div className="h-full overflow-y-auto custom-scrollbar p-6 pb-20 animate-fade-in">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Study Guides</h1>
                <p className="text-gray-500 mt-2">AI-generated cheat sheets and summaries focused on specific topics.</p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    {topics.length === 0 && (
                        <div className="col-span-full p-8 text-center bg-gray-50 rounded-xl border border-dashed border-gray-300 text-gray-500">
                            No topics found yet. Upload and analyze exam papers to detect topics.
                        </div>
                    )}
                </div>
            </div>
